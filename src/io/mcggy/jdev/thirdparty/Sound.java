package io.mcggy.jdev.thirdparty;
import java.io.*;
import javax.sound.sampled.*;

/**
 * Plays the sound (swing based).
 * <br><br><b>Usage:</b>
 * <br>TO PLAY: snd.playSound(s) where 's' is path to a sound
 * <br>TO STOP: snd.stop()
 * <br><br><b>WARNING!!!</b> io.mcggy.jdev.thirdparty.Sound DOES NOT support
 * multisounding (e.g when plays 2 (or more) sounds using one
 * Sound object) - Solve: use separate sound objects for separate
 * sounds, playing at a time.
 * <br><b>WARNING!!!</b> Only WAV/AU/AIF sound formats are accepted!
 * @author habrahabr.ru/users/raid
 */
public class Sound {
